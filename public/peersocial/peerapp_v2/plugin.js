define(function(require, exports, module) {
    ...
    function appPlugin(options, imports, register) {
        ...
        function deleteConfirm(text, done){
            var model = $(require("text!./delete_confirm.html"));
                ...
                init: function() {
                    ...
                    imports.profile.add_profile_tab(function(query, me, user, profile, profileLayout) {
                        if (query == "peerapp2") {
                            ...
                            imports.app.layout.ejs.render(require("text!./profile_app_list.html"), {
                                query: query,
                                me: me,
                                user: user,
                                profile: profile
                               ...
                               profile_app_list.find(".deleteApp2").click((e) => {
                                ...
                                profile_app_list.find("#createApp2").click(() => {
                                    ...
                                    var model = $(require("text!../peerapp_v2/createApp.html"));
                            ...
                            gunfs.stat($query.url, function(err, stat) {
                                ...
                                if (stat.mime == "folder") {
                                    gunfs.readdir($query.url, function(err, list) {
                                        ...
                                        var layout = $(imports.app.layout.ejs.render(require("text!./peerapp_files.html"), {
                                            list: list,
                                            query: $query,
