...
(function (console) {
  var fileName, env, fs, vm, path, exec, dir, nodeRequire, reqMain, existsForNode;
  ...
  if (env === 'browser') {
    ...
    (function () {
      ...
      require.makeDefineWrapper = function (contents, url, context) {
        var defineAtStart = contents.indexOf("define") == 0;

        if (!defineAtStart && context.config.babel) {
          // debugger;
          ...
          return `(()=>{var exports,require = requirejs, module;${contents}                    
})();
//# sourceURL=${url}`
        }
      };
        ...
        fetch(url).then(async (response) => {
          ...
          if (status == 200) {
            ...
            if (url.substr(-4) == "json")
              ...
              response = require.makeDefineWrapper(response, responseURL, context);
            }
    ...
    (function () {
      ...
      req.makeJSONWrapper = function (contents) {
        return `(function (require, requirejs, define) { 
      ...
      req.load = function (context, moduleName, url) {
        ...
        if (exists(url)) {
          ...
          if (url.substr(-4) == "json")
            contents = req.makeJSONWrapper(contents);
          else
  ...
  define('text', ['module', 'require'], function (module, require) {
    'use strict';
  ...
  if (env === 'node' && reqMain !== module) {
    ...
    if (typeof module == "object" && module.exports) module.exports = requirejs;
    return;
  }
