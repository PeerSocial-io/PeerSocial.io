                            ...
                            if(username && userid32){
                                gun.user("@" + username).once(async(data) => {
                                    ...
                                    if ($$peer) {
                                        ...
                                        var peerCard = $(await imports.app.layout.ejs.render(require("./peer-card.html"), { bio: "", profileImage:$$peer.profileImage, alias: $$peer.alias, pub: $$peer.pub, uid32: $$peer.uid32, add: true }, { async: true }));
